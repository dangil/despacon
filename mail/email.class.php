<?php
	...
	class Email{
...

		{
			...
			$this->mail->Host = "smtp.despacon.com.br"; //SERVIDOR DE SMTP, USE smtp.SeuDominio.com OU smtp.hostsys.com.br 

			$this->mail->SMTPAuth = true; 

			$this->mail->Username = "nfe@despacon.com.br"; //Email PARA SMTP AUTENTICADO (pode ser qualquer conta de email do seu domínio)

			$this->mail->Password = "n13f07e2011"; //SENHA DO EMAIL PARA SMTP AUTENTICADO

			$this->mail->From = 'nfe@despacon.com.br'; //E-MAIL DO REMETENTE 
